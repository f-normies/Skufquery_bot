...
async def new_poll(update: Update, context: ContextTypes.DEFAULT_TYPE, polls_data, save_polls_data, logger) -> None:
    if not context.args:
...
async def receive_poll_answer(update: Update, context: ContextTypes.DEFAULT_TYPE, polls_data, save_polls_data, logger) -> None:
...
async def close_poll(update: Update, context: ContextTypes.DEFAULT_TYPE, polls_data, save_polls_data, logger) -> None:
    force_close = False
    poll_id_arg = None
...
async def list_polls(update: Update, context: ContextTypes.DEFAULT_TYPE, polls_data, save_polls_data) -> None:
    if not polls_data:
        await context.bot.send_message(chat_id=update.effective_chat.id, 
                                       reply_to_message_id=update.message.message_id, 
